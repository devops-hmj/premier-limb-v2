...
<section class="wp-block-group bg-spine text-paper py-24 lg:py-32" id="consult">
	...
	<div class="wp-block-group mx-auto max-w-wrap px-6 lg:px-12 grid grid-cols-12 gap-6 lg:gap-8 items-end">
		...
		<div class="wp-block-group js-reveal col-span-12 lg:col-span-7">
			...
			<!-- wp:heading {"level":2,"className":"mt-5 font-serif font-medium tracking-[-0.03em] text-paper leading-[0.96] text-[clamp(44px,7vw,110px)]"} -->
			<h2 class="wp-block-heading mt-5 font-serif font-medium tracking-[-0.03em] text-paper leading-[0.96] text-[clamp(44px,7vw,110px)]">The most important call<br>you’ll make this <em class="italic text-gold">year.</em></h2>
			<!-- /wp:heading -->
		</div>
		<!-- /wp:group -->
		...
		<div class="wp-block-group js-reveal pll-delay-100 col-span-12 lg:col-span-5 lg:pl-6 lg:border-l border-white/25">
			...
			<p class="font-serif italic text-[20px] lg:text-[22px] text-paper/95 mb-7 leading-[1.3]">Confidential · no obligation. Consultations are private, discreet, and can be held virtually.</p>
			<!-- /wp:paragraph -->
			...
			<div class="wp-block-buttons flex flex-col gap-3 items-start">
				<!-- wp:button -->
				<div class="wp-block-button"><a class="wp-block-button__link wp-element-button group inline-flex items-center gap-3 px-5 py-3.5 text-ink uppercase tracking-wide text-[12px] font-medium hover:bg-paper transition-colors bg-gold" href="/#book">Schedule a Confidential Consultation <span class="font-serif italic text-[17px] transition-transform group-hover:translate-x-1" aria-hidden="true">→</span></a></div>
				<!-- /wp:button -->
