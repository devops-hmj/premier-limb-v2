...
<!-- wp:group {"layout":{"type":"default"},"className":"relative z-10 mx-auto max-w-wrap w-full px-6 lg:px-12 pt-3 lg:pt-4 grid grid-cols-12 gap-4 lg:gap-8"} -->
<div class="wp-block-group relative z-10 mx-auto max-w-wrap w-full px-6 lg:px-12 pt-3 lg:pt-4 grid grid-cols-12 gap-4 lg:gap-8">
...
<!-- wp:group {"tagName":"section","layout":{"type":"default"},"className":"relative z-10 flex-1 flex flex-col mx-auto max-w-wrap w-full px-6 lg:px-12 pt-5 lg:pt-6 pb-6 lg:pb-8"} -->
<section class="wp-block-group relative z-10 flex-1 flex flex-col mx-auto max-w-wrap w-full px-6 lg:px-12 pt-5 lg:pt-6 pb-6 lg:pb-8">
	...
	<!-- wp:heading {"level":1,"className":"js-reveal pll-delay-100 font-serif font-normal text-white tracking-[-0.025em] leading-[0.92] max-w-[14ch] mt-5 lg:mt-6 text-[clamp(46px,min(7.4vw,13vh),180px)] [text-shadow:0_2px_30px_rgba(0,0,0,0.4)]"} -->
	<h1 class="wp-block-heading js-reveal pll-delay-100 font-serif font-normal text-white tracking-[-0.025em] leading-[0.92] max-w-[14ch] mt-5 lg:mt-6 text-[clamp(46px,min(7.4vw,13vh),180px)] [text-shadow:0_2px_30px_rgba(0,0,0,0.4)]">Cosmetic<br>limb<br>lengthening, <em class="italic text-gold">done<br>with care.</em></h1>
	<!-- /wp:heading -->
	...
	<div class="wp-block-group js-reveal pll-delay-300 mt-auto pt-5 pb-5 border-t border-white/35 border-b grid grid-cols-12 gap-4 items-baseline">
		<!-- wp:paragraph {"className":"col-span-12 lg:col-span-7 font-serif italic text-white leading-[1.2] text-[clamp(18px,2.1vw,26px)]"} -->
		<p class="col-span-12 lg:col-span-7 font-serif italic text-white leading-[1.2] text-[clamp(18px,2.1vw,26px)]">Gain up to 6 inches with one of the most experienced limb lengthening surgeons on the West Coast.</p>
		<!-- /wp:paragraph -->

		<!-- wp:group {"layout":{"type":"default"},"className":"col-span-12 lg:col-span-5 font-mono uppercase text-[10.5px] tracking-[0.18em] text-white/85 leading-[1.7]"} -->
		<div class="wp-block-group col-span-12 lg:col-span-5 font-mono uppercase text-[10.5px] tracking-[0.18em] text-white/85 leading-[1.7]">
			<!-- wp:paragraph -->
