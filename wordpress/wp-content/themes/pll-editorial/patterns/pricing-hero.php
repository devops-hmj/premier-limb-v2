...
/**
 * Title: Pricing — Hero
 * Slug: pll/pricing-hero
 * Categories: pll-sections
 *
 * Port of components/v2/pricing/PricingHero.tsx.
 *
...
<section class="wp-block-group bg-paper-off border-b border-ink pt-28 lg:pt-36 pb-16 lg:pb-20">
	...
	<div class="wp-block-group mx-auto max-w-wrap px-6 lg:px-12 grid grid-cols-12 gap-6 lg:gap-8">
		...
		<div class="wp-block-group js-reveal col-span-12 lg:col-span-8">
			<!-- wp:paragraph {"className":"eyebrow mb-5 text-gold"} -->
			<p class="eyebrow mb-5 text-gold"><span class="text-spine">Transparent Pricing · 2026</span></p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-group js-reveal pll-delay-100 col-span-12 lg:col-span-4 lg:pl-6 lg:border-l border-rule lg:self-end">
			...
			<p class="font-serif italic text-[20px] lg:text-[22px] leading-[1.35] text-ink-soft">Every quote below includes implants, hospitalization, surgical fees, anesthesia, follow-up care, and a defined block of on-site sessions. No surprises.</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:group -->
	</div>
